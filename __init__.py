...
from .operators import merge_leg_bones_operator
...
def register():
    ...
    bpy.utils.register_class(merge_leg_bones_operator.OBJECT_OT_merge_leg_bones)
    # 注册动态属性
...
def unregister():
    ...
    bpy.utils.unregister_class(merge_leg_bones_operator.OBJECT_OT_merge_leg_bones)
